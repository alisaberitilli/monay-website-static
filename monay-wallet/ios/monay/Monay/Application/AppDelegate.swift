...
// @UIApplicationMain - Disabled for SwiftUI
// This file is kept for reference but replaced by MonayApp.swift
class AppDelegateLegacy: UIResponder, UIApplicationDelegate {
