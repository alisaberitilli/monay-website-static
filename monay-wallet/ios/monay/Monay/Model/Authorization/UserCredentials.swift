...
class UserCredentials: Mappable {
    ...
    var profileImage = BehaviorRelay<String>(value: "")
    var email = BehaviorRelay<String>(value: "")
    var phoneNumber = BehaviorRelay<String>(value: "")
    var countryCode = BehaviorRelay<String>(value: "")
    var qrCode = BehaviorRelay<String>(value: "")
    var isMpinSet: Bool?
    var companyName = BehaviorRelay<String>(value: "")
    var taxId = BehaviorRelay<String>(value: "")
    var registrationNumber = BehaviorRelay<String>(value: "")
