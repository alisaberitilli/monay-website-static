...
class BasicUserProfileResponse : BaseResponse<BasicUserProfileResponse, String, Any>() {
    val data: RecentUserData? = null
    override fun doNetworkRequest(
        requestParam: HashMap<String, Any>,
        appPreference: AppPreference,
        networkResponseCallback: NetworkResponseCallback<BasicUserProfileResponse>
    ): Disposable {
