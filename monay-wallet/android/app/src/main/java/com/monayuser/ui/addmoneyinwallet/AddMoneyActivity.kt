...
class AddMoneyActivity : BaseActivity<ActivityAddMoneyBinding, AddMoneyViewModel>(),
    ...
    private fun openExpiryDialog() {
        viewDataBinding!!.cardExMonth.setOnClickListener {
            ...
            // Using MaterialDatePicker for month/year selection
    ...
    private fun initializeAdapter() {
        viewDataBinding!!.cardRecycler.layoutManager = LinearLayoutManager(this)
        ...
        viewDataBinding!!.cardRecycler.adapter = cardAdapter
        ...
        cardAdapter!!.setOntemClickListener(object :
            ...
            override fun onItemClicked(view: View, position: Int) {
                ...
                if (mAddMoneyViewModel.checkValidation(
                    ...
                    if (etCvv.text.toString().trim().isEmpty()) {
    ...
    override fun showAddNewCardDialog() {
        if (mAddMoneyViewModel.checkValidation(
            ...
            // your work
            bottomSheet.findViewById<android.widget.ImageView>(R.id.imageCloseDialog).setOnClickListener { dialog!!.dismiss() }
            bottomSheet.findViewById<android.widget.CheckBox>(R.id.cb_save).visibility = View.VISIBLE
            bottomSheet.findViewById<android.widget.CheckBox>(R.id.cb_save).isChecked = true
            bottomSheet.findViewById<android.widget.EditText>(R.id.etMonth).setOnClickListener {
                ...
                val mDatePicker = DatePickerDialog(
                    ...
                    DatePickerDialog.OnDateSetListener { datePicker: DatePicker, mYear: Int, mMonth: Int, dayOfMonth: Int ->
                        ...
                        bottomSheet.findViewById<android.widget.EditText>(R.id.etMonth).setText(
                            CommonUtils.getDateInFormat(
                                "yyyy-MM-dd",
                                "MM/yy",
            ...
            bottomSheet.findViewById<android.widget.Button>(R.id.btnAddCard).setOnClickListener {

                if (bottomSheet.findViewById<android.widget.CheckBox>(R.id.cb_save).isChecked) {
                    cardBeanMain!!.saveCard = "yes"
                } else {
                    cardBeanMain!!.saveCard = "no"
                }
                cardBeanMain!!.nameOnCard = bottomSheet.findViewById<android.widget.EditText>(R.id.etCardHolderName).text.toString()
                cardBeanMain!!.cardNumber = bottomSheet.findViewById<android.widget.EditText>(R.id.etCardNumber).text.toString()
                cardBeanMain!!.year = yearMain
                cardBeanMain!!.month = monthMain
                cardBeanMain!!.cvv = bottomSheet.findViewById<android.widget.EditText>(R.id.etCvv).text.toString()
