...
class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
    val bottom_view: android.widget.LinearLayout = itemView.findViewById(R.id.bottom_view)
    val payText: android.widget.TextView = itemView.findViewById(R.id.payText)
    val declineText: android.widget.TextView = itemView.findViewById(R.id.declineText)
    val paymenntStatus: android.widget.TextView = itemView.findViewById(R.id.payment_status)
    ...
    val tvMessage: android.widget.TextView = itemView.findViewById(R.id.tv_message)
}