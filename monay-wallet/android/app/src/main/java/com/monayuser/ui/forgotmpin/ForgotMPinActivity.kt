...
class ForgotMPinActivity : BaseActivity<ActivityForgotPinBinding, ForgotMPinViewModel>(),
    ...
    override fun init() {
        if (Build.VERSION.SDK_INT <= Build.VERSION_CODES.M) {
            viewDataBinding!!.forgotPinview.splitWidth = 15
            viewDataBinding!!.forgotPinview.pinHeight = 90
            viewDataBinding!!.forgotPinview.pinWidth = 135
        }
        viewDataBinding!!.forgotPinview.showCursor(true)
