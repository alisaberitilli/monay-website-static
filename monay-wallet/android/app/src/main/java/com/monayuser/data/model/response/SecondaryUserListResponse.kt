...
import com.monayuser.data.model.bean.SecondaryUserBean
...
class SecondaryUserListResponse : BaseResponse<SecondaryUserListResponse, String, Any>() {

    var data: SecondaryUserBean? = null
    override fun doNetworkRequest(
        requestParam: HashMap<String, Any>,
        appPreference: AppPreference,
        networkResponseCallback: NetworkResponseCallback<SecondaryUserListResponse>
    ): Disposable {
        val api = ApiFactory.clientWithHeader.create(ApiInterface::class.java)
        return api.getSecondaryUserListAPI(
