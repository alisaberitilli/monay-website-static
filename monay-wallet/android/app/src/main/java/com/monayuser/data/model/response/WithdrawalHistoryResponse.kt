...
class WithdrawalHistoryResponse : BaseResponse<WithdrawalHistoryResponse, String, Any>() {

    var data: TransactionBean? = null
    override fun doNetworkRequest(
        requestParam: HashMap<String, Any>,
        appPreference: AppPreference,
        networkResponseCallback: NetworkResponseCallback<WithdrawalHistoryResponse>
    ): Disposable {
        val api = ApiFactory.clientWithHeader.create(ApiInterface::class.java)
        return api.withdrawalHistoryListAPI(
