package com.monayuser.ui.autotopup.adapter
...
class CardAutoTopUpAdapter(
    val context: Context,
    val items: ArrayList<CardBeanAutoTopUp>,
    ...
    interface OnItemClickListener {
        ...
        fun onItemChecked(view: View, cardBean: CardBeanAutoTopUp)
    }
...
class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
    ...
    val cardIV: android.widget.ImageView = itemView.findViewById(R.id.cardIV)
    val bankCard: android.widget.RadioButton = itemView.findViewById(R.id.radioBankCard)
    val card_bank_name: android.widget.TextView = itemView.findViewById(R.id.card_bank_name)
    val tvLastDigit: android.widget.TextView = itemView.findViewById(R.id.tvLastDigit)
    val llCvv: android.widget.LinearLayout = itemView.findViewById(R.id.ll_cvv)
    val etCvv: android.widget.EditText = itemView.findViewById(R.id.etCvv)
    val btnPay: android.widget.Button = itemView.findViewById(R.id.btn_pay)
}