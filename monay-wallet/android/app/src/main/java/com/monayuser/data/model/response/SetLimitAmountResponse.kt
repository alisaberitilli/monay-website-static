...
class SetLimitAmountResponse : BaseResponse<SetLimitAmountResponse, String, Any>() {
    val data: SecondaryUserDetail? = null
    override fun doNetworkRequest(
        requestParam: HashMap<String, Any>,
        appPreference: AppPreference,
        networkResponseCallback: NetworkResponseCallback<SetLimitAmountResponse>
    ): Disposable {
        ...
        return api.secondaryUserLimitAPI(
            "${AppConstants.BEARER} ${
