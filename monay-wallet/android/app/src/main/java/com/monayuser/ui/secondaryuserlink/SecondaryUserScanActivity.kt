...
class SecondaryUserScanActivity : BaseActivity<SecondaryUserScanBinding, SecondaryUserScanViewModel>(), SecondaryUserScanNavigator,
    ...
    {
        mScannerView = CompoundBarcodeView(this@SecondaryUserScanActivity)
...
//            }
    ...
    override fun barcodeResult(result: BarcodeResult) {
        var id: String? = CommonUtils.getJsonValueStr("userId", CommonUtils.getJsonObject(result.text))
        Log.d("serverscan","===="+CommonUtils.getJsonObject(result.text))
        var uId: String? = id!!
