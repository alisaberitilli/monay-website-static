...
class AutoTopUpEnableDisableResponse : BaseResponse<AutoTopUpEnableDisableResponse, String, Any>() {
    val data: SecondaryUserDetail? = null
    override fun doNetworkRequest(
        requestParam: HashMap<String, Any>,
        appPreference: AppPreference,
        networkResponseCallback: NetworkResponseCallback<AutoTopUpEnableDisableResponse>
    ): Disposable {
      ...
      /*  userId = requestParam["userId"].toString()
        ...
        return api.autoTopUpEnableDisableAPI(
            "${AppConstants.BEARER} ${
