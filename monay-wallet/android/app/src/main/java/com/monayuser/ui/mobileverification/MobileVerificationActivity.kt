...
/*        intent.putExtra(AppConstants.REFERRAL_CODE,referralCode)
    ...
    override fun init() {
        ...
        if (viewDataBinding!!.spinnerMobileVerify != null) {
            val adapter = ArrayAdapter(
                this@MobileVerificationActivity,
                R.layout.spinner_textview,
                countryCode
            )
            viewDataBinding!!.spinnerMobileVerify.adapter = adapter
        }
        viewDataBinding!!.spinnerMobileVerify.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
