...
class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
    val tvUserName: android.widget.TextView = itemView.findViewById(R.id.tvName)
    val tvUserNumber: android.widget.TextView = itemView.findViewById(R.id.tvNumber)
    val tvUserAmount: android.widget.TextView = itemView.findViewById(R.id.tvAmount)
    val radioButton: android.widget.RadioButton = itemView.findViewById(R.id.radioUserSelect)
