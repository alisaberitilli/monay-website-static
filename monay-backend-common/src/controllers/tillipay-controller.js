...
export const testConnection = async (req, res) => {
  try {
    const result = await tilliPayService.testConnection();
...
export const createPaymentLink = async (req, res) => {
  try {
    ...
    const paymentLink = await tilliPayService.createPaymentLink({
      amount,
      currency,
      orderId,
      description,
...
export const processCardPayment = async (req, res) => {
  try {
    ...
    const payment = await tilliPayService.processCardPayment({
      amount,
      currency,
      orderId,
      cardNumber,
...
export const processACHPayment = async (req, res) => {
  try {
    ...
    const payment = await tilliPayService.processACHPayment({
      amount,
      currency,
      orderId,
      accountNumber,
...
export const getPaymentStatus = async (req, res) => {
  try {
    ...
    const status = await tilliPayService.getPaymentStatus(transaction.externalId);
...
export const refundPayment = async (req, res) => {
  try {
    ...
    const refund = await tilliPayService.refundPayment({
...
export const capturePayment = async (req, res) => {
  try {
    ...
    const capture = await tilliPayService.capturePayment({
      transactionId: transaction.externalId,
...
export const voidPayment = async (req, res) => {
  try {
    ...
    const voidResult = await tilliPayService.voidPayment({
      transactionId: transaction.externalId,
      reason,
      metadata: {
        transactionId: transaction.id,
...
export const getTransactionHistory = async (req, res) => {
  try {
    ...
    const history = await tilliPayService.getTransactionHistory({
      startDate,
      endDate,
...
export const handleWebhook = async (req, res) => {
  try {
    ...
    const result = await tilliPayService.handleWebhook(payload, signature);
