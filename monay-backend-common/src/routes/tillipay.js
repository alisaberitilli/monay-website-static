...
import * as tilliPayController from '../controllers/tillipay-controller';
...
router.get(
  '/test-connection',
  auth,
  tilliPayController.testConnection
);
...
router.post(
  ...
  validateRequest,
  tilliPayController.createPaymentLink
);
...
router.post(
  ...
  validateRequest,
  tilliPayController.processCardPayment
);
...
router.post(
  ...
  validateRequest,
  tilliPayController.processACHPayment
);
...
router.get(
  ...
  param('transactionId').isUUID().withMessage('Invalid transaction ID'),
  validateRequest,
  tilliPayController.getPaymentStatus
);
...
router.post(
  ...
  refundValidation,
  validateRequest,
  tilliPayController.refundPayment
);
...
router.post(
  ...
  captureValidation,
  validateRequest,
  tilliPayController.capturePayment
);
...
router.post(
  ...
  voidValidation,
  validateRequest,
  tilliPayController.voidPayment
);
...
router.get(
  ...
  validateRequest,
  tilliPayController.getTransactionHistory
);

router.post(
  '/webhook',
  express.raw({ type: 'application/json' }),
  tilliPayController.handleWebhook
);
