...
export default function VtigerFormWrapper({
  children,
  formData,
  formType,
  onSubmit,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const vtigerResult = await sendToVtigerServer(formData, formType);
  ...
  const handleCaptchaChange = (value: string | null) => {
    ...
    if (value) {
      setSubmitError(null); // Clear error when captcha is completed
    }
  };
