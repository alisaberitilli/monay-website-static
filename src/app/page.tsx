...
export default function Home() {
  ...
  useEffect(() => {
    ...
    if (typeof window !== 'undefined' && !(window as any).reb2b) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Send to both our API and the existing client-side service
      const userData = {
      ...
      const clientPromise = handleContactForm(userData);
      
      // Wait for both to complete
      const [apiResult, clientResult] = await Promise.allSettled([apiPromise, clientPromise]);
      
      // Consider success if at least one succeeded
      const success = apiResult.status === 'fulfilled' || clientResult.status === 'fulfilled';
  ...
  return (
    <div className={`min-h-screen transition-colors duration-300 ${
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
              ...
              <a href="#pilot-program" className="group relative inline-flex items-center justify-center px-8 py-3.5 font-semibold text-white transition-all duration-200 bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl hover:from-blue-700 hover:to-purple-700 transform hover:-translate-y-0.5 hover:shadow-xl">
                <span className="relative">Join Pilot Coin Program</span>
                <div className="absolute inset-0 rounded-xl bg-gradient-to-r from-blue-600 to-purple-600 opacity-0 group-hover:opacity-100 blur-xl transition-opacity duration-200"></div>
              </a>
              
              {/* Secondary CTA - Outlined with hover fill */}
              <button onClick={() => openCalendly()} className="group relative inline-flex items-center justify-center px-8 py-3.5 font-semibold border-2 border-blue-600 text-blue-600 rounded-xl transition-all duration-200 hover:bg-blue-600 hover:text-white hover:border-blue-700 transform hover:-translate-y-0.5 hover:shadow-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto mt-12">
              ...
              <div className={`${isDarkMode ? 'bg-gray-800/60 border-gray-600' : 'bg-white/60 border-gray-200'} backdrop-blur-sm p-6 rounded-xl border transition-all duration-300 hover:shadow-xl hover:scale-105`}>
                ...
                <h3 className={`text-lg font-semibold mb-2 ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>Monay CaaS <span className="text-xs text-blue-600 ml-2">~76%</span></h3>
              ...
              <div className={`${isDarkMode ? 'bg-gray-800/60 border-gray-600' : 'bg-white/60 border-gray-200'} backdrop-blur-sm p-6 rounded-xl border transition-all duration-300 hover:shadow-xl hover:scale-105`}>
                ...
                <h3 className={`text-lg font-semibold mb-2 ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>Monay WaaS <span className="text-xs text-purple-600 ml-2">~86%</span></h3>
      ...
      {/* Federal Initiative Alignment Section */}
      <section className={`py-20 transition-colors duration-300 ${isDarkMode ? 'bg-gray-800/50' : 'bg-blue-50'}`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <span className="inline-block px-4 py-2 bg-gradient-to-r from-blue-600 to-indigo-600 text-white text-sm font-semibold rounded-full mb-4">
              ALIGNED WITH 2025 EXECUTIVE ORDERS
            </span>
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-6xl mx-auto">
            {/* Digital Financial Technology EO */}
            <div className={`${isDarkMode ? 'bg-gray-900 border-gray-700' : 'bg-white border-gray-200'} p-6 rounded-xl border hover:shadow-xl transition-all duration-300`}>
              <div className="flex items-center mb-4">
                ...
                <div>
                  <h3 className={`font-semibold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>Digital Asset Leadership</h3>
                  <p className={`text-xs ${isDarkMode ? 'text-blue-400' : 'text-blue-600'}`}>EO: Jan 23, 2025</p>
                </div>
              </div>
              <ul className={`space-y-2 text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>
                <li className="flex items-start">
                  ...
                  USD-backed stablecoins (GENIUS Act)
                </li>
                <li className="flex items-start">
                  <svg className="w-4 h-4 text-green-500 mr-2 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                  Strategic Bitcoin Reserve support
                </li>
                <li className="flex items-start">
                  <svg className="w-4 h-4 text-green-500 mr-2 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
              ...
              <a href="/solutions/government-programs#digital-financial-leadership" className="inline-flex items-center text-orange-600 hover:text-orange-700 text-sm font-semibold group transition-all duration-200 mt-4">
                Learn more 
                <svg className="w-4 h-4 ml-1 transform group-hover:translate-x-1 transition-transform duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                </svg>
            ...
            <div className={`${isDarkMode ? 'bg-gray-900 border-gray-700' : 'bg-white border-gray-200'} p-6 rounded-xl border hover:shadow-xl transition-all duration-300`}>
              <div className="flex items-center mb-4">
                ...
                <div>
                  <h3 className={`font-semibold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>Education Freedom</h3>
                  <p className={`text-xs ${isDarkMode ? 'text-blue-400' : 'text-blue-600'}`}>EO: Jan 29, 2025</p>
                </div>
              </div>
              <ul className={`space-y-2 text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>
                <li className="flex items-start">
              ...
              <a href="/solutions/government-programs#education-freedom" className="inline-flex items-center text-purple-600 hover:text-purple-700 text-sm font-semibold group transition-all duration-200 mt-4">
                Learn more 
                <svg className="w-4 h-4 ml-1 transform group-hover:translate-x-1 transition-transform duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                </svg>
            ...
            {/* How Monay Delivers */}
            <div className={`${isDarkMode ? 'bg-gradient-to-br from-blue-900 to-indigo-900 border-blue-700' : 'bg-gradient-to-br from-blue-50 to-indigo-50 border-blue-200'} p-6 rounded-xl border hover:shadow-xl transition-all duration-300`}>
              <div className="flex items-center mb-4">
                ...
                <div>
                  <h3 className={`font-semibold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>Monay Delivers</h3>
                  <p className={`text-xs ${isDarkMode ? 'text-green-400' : 'text-green-600'}`}>Ready Today</p>
                </div>
              </div>
      ...
      <section className={`py-20 transition-colors duration-300 ${isDarkMode ? 'bg-gray-900' : 'bg-gray-50'}`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className={`text-xl max-w-3xl mx-auto ${isDarkMode ? 'text-gray-300' : 'text-gray-800'}`}>
              Product roadmap and key milestones for 2025-2026
            </p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
            {/* Q4 2025 MVP Launch */}
            <div className={`${isDarkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'} p-6 rounded-xl border-2 hover:shadow-xl transition-all duration-300`}>
              <div className="flex items-center mb-4">
                ...
                <div>
                  <h3 className={`text-lg font-bold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>Q4 2025</h3>
                  <p className={`text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>MVP Launch</p>
                </div>
              </div>
              <ul className={`space-y-2 text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>
                <li className="flex items-start">
                  <span className="text-green-500 mr-2 mt-1">•</span>
                  <span>Core WaaS Platform</span>
                </li>
                <li className="flex items-start">
                  <span className="text-green-500 mr-2 mt-1">•</span>
                ...
                <li className="flex items-start">
                  <span className="text-green-500 mr-2 mt-1">•</span>
                  <span>Initial payment rails</span>
                </li>
              </ul>
            </div>
            ...
            <div className={`${isDarkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'} p-6 rounded-xl border-2 hover:shadow-xl transition-all duration-300`}>
              <div className="flex items-center mb-4">
                ...
                <div>
                  <h3 className={`text-lg font-bold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>Q1 2026</h3>
                  <p className={`text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>Enterprise Ready</p>
                </div>
              </div>
              <ul className={`space-y-2 text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>
                <li className="flex items-start">
                  <span className="text-green-500 mr-2 mt-1">•</span>
                  <span>CaaS platform launch</span>
                </li>
                <li className="flex items-start">
                  <span className="text-green-500 mr-2 mt-1">•</span>
            ...
            <div className={`${isDarkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'} p-6 rounded-xl border-2 hover:shadow-xl transition-all duration-300`}>
              <div className="flex items-center mb-4">
                ...
                <div>
                  <h3 className={`text-lg font-bold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>Q2 2026</h3>
                  <p className={`text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>Scale & Features</p>
                </div>
              </div>
              <ul className={`space-y-2 text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>
                <li className="flex items-start">
                  <span className="text-green-500 mr-2 mt-1">•</span>
                  <span>Card issuing program</span>
                </li>
                <li className="flex items-start">
                  <span className="text-green-500 mr-2 mt-1">•</span>
            ...
            <div className={`${isDarkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'} p-6 rounded-xl border-2 hover:shadow-xl transition-all duration-300`}>
              <div className="flex items-center mb-4">
                ...
                <div>
                  <h3 className={`text-lg font-bold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>Q3 2026</h3>
                  <p className={`text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>AI & Automation</p>
                </div>
              </div>
              <ul className={`space-y-2 text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>
                <li className="flex items-start">
            ...
            <div className={`${isDarkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'} p-6 rounded-xl border-2 hover:shadow-xl transition-all duration-300`}>
              <div className="flex items-center mb-4">
                ...
                <div>
                  <h3 className={`text-lg font-bold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>Key Milestones</h3>
                  <p className={`text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>2025-2026</p>
                </div>
              </div>
              <ul className={`space-y-2 text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>
                <li className="flex items-start">
                ...
                <li className="flex items-start">
                  <span className="text-blue-500 mr-2 mt-1">•</span>
                  <span>$50M+ transaction volume</span>
                </li>
                <li className="flex items-start">
                  <span className="text-blue-500 mr-2 mt-1">•</span>
                  <span>10+ country coverage</span>
                </li>
                <li className="flex items-start">
                  <span className="text-blue-500 mr-2 mt-1">•</span>
            ...
            <div className={`${isDarkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'} p-6 rounded-xl border-2 hover:shadow-xl transition-all duration-300`}>
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 bg-gradient-to-r from-yellow-600 to-orange-600 rounded-lg flex items-center justify-center mr-4">
                  <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z" />
                  </svg>
                </div>
                <div>
                  <h3 className={`text-lg font-bold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>Future Vision</h3>
                  <p className={`text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>Beyond 2026</p>
                </div>
              </div>
              <ul className={`space-y-2 text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>
                <li className="flex items-start">
                  <span className="text-yellow-500 mr-2 mt-1">•</span>
                  <span>Global payment standard</span>
                </li>
                <li className="flex items-start">
                  <span className="text-yellow-500 mr-2 mt-1">•</span>
                  <span>CBDC integration</span>
                </li>
                <li className="flex items-start">
                  <span className="text-yellow-500 mr-2 mt-1">•</span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className={`${isDarkMode ? 'bg-gradient-to-br from-gray-700 to-gray-600 border-gray-600' : 'bg-gradient-to-br from-blue-50 to-indigo-50 border-blue-100'} p-8 rounded-xl border hover:shadow-lg transition-all duration-300 transform hover:-translate-y-2`}>
              ...
              <p className={`${isDarkMode ? 'text-gray-300' : 'text-gray-800'}`}>Issue branded stablecoins (USDM) with native support on Monay Wallet, integrated with global settlement networks.</p>
            </div>
            ...
            <div className={`${isDarkMode ? 'bg-gradient-to-br from-gray-700 to-gray-600 border-gray-600' : 'bg-gradient-to-br from-purple-50 to-pink-50 border-purple-100'} p-8 rounded-xl border hover:shadow-lg transition-all duration-300 transform hover:-translate-y-2`}>
              ...
              <p className={`${isDarkMode ? 'text-gray-300' : 'text-gray-800'}`}>Deploy branded digital wallets with seamless integration to multiple stablecoin rails and fiat on-ramps.</p>
            </div>
            ...
            <div className={`${isDarkMode ? 'bg-gradient-to-br from-gray-700 to-gray-600 border-gray-600' : 'bg-gradient-to-br from-green-50 to-emerald-50 border-green-100'} p-8 rounded-xl border hover:shadow-lg transition-all duration-300 transform hover:-translate-y-2`}>
              ...
              <p className={`${isDarkMode ? 'text-gray-300' : 'text-gray-800'}`}>Low-code engine for KYC, verification, fraud prevention, and compliance across all payment flows.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li className="flex items-center gap-3">
                  ...
                  <span className={`${isDarkMode ? 'text-gray-300' : 'text-gray-800'}`}>Cross-chain stablecoin interoperability</span>
                </li>
                <li className="flex items-center gap-3">
                  <div className="w-5 h-5 bg-blue-600 rounded-full flex items-center justify-center">
                    <svg className="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <span className={`${isDarkMode ? 'text-gray-300' : 'text-gray-800'}`}>Global settlement network integration</span>
                </li>
                <li className="flex items-center gap-3">
                  <div className="w-5 h-5 bg-blue-600 rounded-full flex items-center justify-center">
                    <svg className="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <span className={`${isDarkMode ? 'text-gray-300' : 'text-gray-800'}`}>Advanced compliance and program controls</span>
                </li>
              </ul>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className={`${isDarkMode ? 'bg-gray-800 border-gray-600' : 'bg-white border-gray-200'} p-8 rounded-xl border transition-colors duration-300`}>
              ...
              <p className={`mb-4 ${isDarkMode ? 'text-gray-300' : 'text-gray-800'}`}>Low-code engine for intelligent eligibility, KYC/KYB, spend controls, fraud prevention, and compliance.</p>
            ...
            <div className={`${isDarkMode ? 'bg-gray-800 border-gray-600' : 'bg-white border-gray-200'} p-8 rounded-xl border transition-colors duration-300`}>
              ...
              <p className={`mb-4 ${isDarkMode ? 'text-gray-300' : 'text-gray-800'}`}>Seamless integrations with leading platforms for fiat conversion and secure custody.</p>
              <ul className={`space-y-2 text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-800'}`}>
          ...
          {/* Invoice First - Advanced Platform Capability */}
          <div className={`mt-8 ${isDarkMode ? 'bg-gradient-to-r from-purple-900 to-blue-900' : 'bg-gradient-to-r from-purple-50 to-blue-50'} p-8 rounded-xl border-2 ${isDarkMode ? 'border-purple-700' : 'border-purple-200'}`}>
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className={`text-2xl font-bold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>Invoice First™ - Enterprise Transaction Platform</h3>
            </div>
            
            <p className={`text-lg mb-6 ${isDarkMode ? 'text-gray-200' : 'text-gray-800'}`}>
              Every enterprise transaction is backed by a verified invoice, creating an immutable audit trail and enabling intelligent payment automation across your entire financial ecosystem.
            </p>
            
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className={`${isDarkMode ? 'bg-gray-800/50' : 'bg-white'} p-6 rounded-lg`}>
                <h4 className={`font-bold mb-3 ${isDarkMode ? 'text-purple-400' : 'text-purple-600'}`}>ERP Integration</h4>
                <ul className={`space-y-2 text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-800'}`}>
                  <li>• SAP, Oracle, Microsoft Dynamics</li>
                  <li>• Real-time invoice synchronization</li>
              ...
              <div className={`${isDarkMode ? 'bg-gray-800/50' : 'bg-white'} p-6 rounded-lg`}>
                <h4 className={`font-bold mb-3 ${isDarkMode ? 'text-purple-400' : 'text-purple-600'}`}>Bill Aggregator Network</h4>
                <ul className={`space-y-2 text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-800'}`}>
                  <li>• Bill.com, Coupa, Ariba integration</li>
              ...
              <div className={`${isDarkMode ? 'bg-gray-800/50' : 'bg-white'} p-6 rounded-lg`}>
                <h4 className={`font-bold mb-3 ${isDarkMode ? 'text-purple-400' : 'text-purple-600'}`}>Banking & Core Systems</h4>
                <ul className={`space-y-2 text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-800'}`}>
                  <li>• Direct bank API connections</li>
                  <li>• Core banking integration (FIS, Fiserv)</li>
            ...
            <div className={`mt-6 p-4 ${isDarkMode ? 'bg-purple-800/30' : 'bg-purple-100'} rounded-lg`}>
              <p className={`text-sm ${isDarkMode ? 'text-purple-200' : 'text-purple-700'} font-semibold mb-2`}>
                Key Benefits:
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                <span className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-800'}`}>✓ 100% transaction auditability</span>
                <span className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-800'}`}>✓ 70% reduction in payment disputes</span>
                <span className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-800'}`}>✓ Real-time fraud prevention</span>
                <span className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-800'}`}>✓ Automated tax compliance</span>
                <span className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-800'}`}>✓ Instant payment verification</span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-16">
            <div className="text-center">
              ...
              <p className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-800'}`}>Visa, Mastercard, American Express</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-800'}`}>AllPoint Network</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-800'}`}>USDC, USDT, USDP</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-800'}`}>Fireblocks, Anchorage, Fidelity</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-16">
            <div className="text-center">
              <div className={`w-16 h-16 rounded-lg flex items-center justify-center mx-auto mb-4 ${isDarkMode ? 'bg-gray-700' : 'bg-indigo-100'}`}>
                <span className="text-indigo-600 font-bold text-lg">BA</span>
              </div>
              <h3 className={`font-semibold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>Bill Aggregators</h3>
              <p className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-800'}`}>Bill.com, Coupa, Ariba</p>
            </div>
            
            <div className="text-center">
              <div className={`w-16 h-16 rounded-lg flex items-center justify-center mx-auto mb-4 ${isDarkMode ? 'bg-gray-700' : 'bg-red-100'}`}>
                <span className="text-red-600 font-bold text-lg">ERP</span>
              </div>
              <h3 className={`font-semibold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>Enterprise Systems</h3>
              <p className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-800'}`}>SAP, Oracle, Microsoft</p>
            </div>
            
            <div className="text-center">
              <div className={`w-16 h-16 rounded-lg flex items-center justify-center mx-auto mb-4 ${isDarkMode ? 'bg-gray-700' : 'bg-teal-100'}`}>
                <span className="text-teal-600 font-bold text-lg">CBS</span>
              </div>
              <h3 className={`font-semibold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>Core Banking</h3>
              <p className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-800'}`}>FIS, Fiserv, Jack Henry</p>
            </div>
            
            <div className="text-center">
              <div className={`w-16 h-16 rounded-lg flex items-center justify-center mx-auto mb-4 ${isDarkMode ? 'bg-gray-700' : 'bg-yellow-100'}`}>
                <span className="text-yellow-600 font-bold text-lg">KYC</span>
              </div>
              <h3 className={`font-semibold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>Compliance</h3>
              <p className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-800'}`}>Persona, Alloy, Onfido</p>
            </div>
          </div>
          ...
          <div className="mb-16">
            <h3 className={`text-2xl font-bold mb-8 text-center ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>
              Transforming Industries with Monay Technology
            </h3>
            
            {/* Monay ID Use Cases */}
            <div className={`${isDarkMode ? 'bg-gray-800' : 'bg-blue-50'} p-8 rounded-2xl mb-6`}>
              <h4 className="text-xl font-bold mb-4 text-blue-600">Monay ID - Authentication Use Cases</h4>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                  <h5 className="font-semibold mb-2">Healthcare</h5>
                  <p className="text-sm">HIPAA-compliant voice authentication for patient portals and telehealth</p>
                </div>
                <div>
                  <h5 className="font-semibold mb-2">Banking</h5>
                  <p className="text-sm">Voice-authenticated phone banking with custodian account recovery</p>
                </div>
                <div>
                  <h5 className="font-semibold mb-2">Enterprise</h5>
                  <p className="text-sm">Unified SSO across all corporate applications with biometric MFA</p>
                </div>
                <div>
                  <h5 className="font-semibold mb-2">E-commerce</h5>
                  <p className="text-sm">Passwordless checkout increasing conversion by 35%</p>
                </div>
                <div>
                  <h5 className="font-semibold mb-2">Government</h5>
                  <p className="text-sm">Citizen identity verification for digital services and benefits</p>
                </div>
                <div>
                  <h5 className="font-semibold mb-2">Education</h5>
                  <p className="text-sm">Student authentication with parental custodian controls</p>
                </div>
              </div>
            </div>

            {/* Monay CaaS Use Cases */}
            <div className={`${isDarkMode ? 'bg-gray-800' : 'bg-purple-50'} p-8 rounded-2xl mb-6`}>
              <h4 className="text-xl font-bold mb-4 text-purple-600">Monay CaaS - Stablecoin Use Cases</h4>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                  <h5 className="font-semibold mb-2">Corporate Treasury</h5>
                  <p className="text-sm">Internal settlements with 80% cost reduction on cross-border payments</p>
                </div>
                <div>
                  <h5 className="font-semibold mb-2">Payroll & Benefits</h5>
                  <p className="text-sm">Instant employee payments in branded tokens with spending controls</p>
                </div>
                <div>
                  <h5 className="font-semibold mb-2">Supply Chain</h5>
                  <p className="text-sm">Vendor payments with automated smart contract settlements</p>
                </div>
                <div>
                  <h5 className="font-semibold mb-2">Loyalty Programs</h5>
                  <p className="text-sm">Tokenized rewards with instant redemption and transferability</p>
                </div>
                <div>
                  <h5 className="font-semibold mb-2">Municipal Currency</h5>
                  <p className="text-sm">City-issued tokens for local economic stimulus and services</p>
                </div>
                <div>
                  <h5 className="font-semibold mb-2">Insurance</h5>
                  <p className="text-sm">Instant claim settlements with programmable disbursements</p>
                </div>
              </div>
            </div>

            {/* Monay WaaS Use Cases */}
            <div className={`${isDarkMode ? 'bg-gray-800' : 'bg-green-50'} p-8 rounded-2xl mb-6`}>
              <h4 className="text-xl font-bold mb-4 text-green-600">Monay WaaS - Wallet Use Cases</h4>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                  <h5 className="font-semibold mb-2">Neobanks</h5>
                  <p className="text-sm">Launch full banking services in 6 weeks with cards and ATM access</p>
                </div>
                <div>
                  <h5 className="font-semibold mb-2">Gig Economy</h5>
                  <p className="text-sm">Instant driver/contractor payouts with virtual cards</p>
                </div>
                <div>
                  <h5 className="font-semibold mb-2">Remittance</h5>
                  <p className="text-sm">Cross-border transfers under $1 with instant settlement</p>
                </div>
                <div>
                  <h5 className="font-semibold mb-2">Gaming</h5>
                  <p className="text-sm">In-game wallets with real money withdrawals to cards</p>
                </div>
                <div>
                  <h5 className="font-semibold mb-2">Expense Management</h5>
                  <p className="text-sm">Corporate cards with programmable spending rules and limits</p>
                </div>
                <div>
                  <h5 className="font-semibold mb-2">Social Payments</h5>
                  <p className="text-sm">P2P transfers with social features and split payments</p>
                </div>
              </div>
            </div>
          </div>

          {/* Original Government Use Cases */}
          <div className={`${isDarkMode ? 'bg-gradient-to-r from-gray-700 to-gray-600' : 'bg-gradient-to-r from-gray-100 to-gray-50'} p-8 rounded-2xl transition-colors duration-300`}>
            <h3 className={`text-2xl font-bold mb-6 text-center ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>Government & Public Sector</h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center">
                <div className="w-12 h-12 bg-blue-600 rounded-lg flex items-center justify-center mx-auto mb-4">
                  <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <section id="pilot-program" className={`py-24 transition-colors duration-300 ${isDarkMode ? 'bg-gradient-to-br from-gray-800 to-gray-900' : 'bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50'}`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* Limited Time Badge */}
          <div className="text-center mb-8">
            <span className="inline-block px-4 py-2 bg-gradient-to-r from-red-500 to-orange-500 text-white text-sm font-bold rounded-full animate-pulse">
              🎉 LIMITED SPOTS AVAILABLE - 75% OFF FIRST YEAR
            </span>
          </div>
          
          <div className="text-center mb-16">
            <h2 className={`text-4xl md:text-5xl font-bold mb-6 ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>
              Be Among the First to Launch Your
              <span className="block text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600 mt-2">
                Digital Currency with Monay
              </span>
            </h2>
            <p className={`text-xl max-w-3xl mx-auto mb-8 ${isDarkMode ? 'text-gray-300' : 'text-gray-800'}`}>
              Join our exclusive Pilot Coin Program and save $50,000+ while getting white-glove support to launch your branded stablecoin on our dual-rail blockchain platform.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 max-w-4xl mx-auto mb-8">
              <div className={`p-4 rounded-lg ${isDarkMode ? 'bg-gray-700' : 'bg-white'} shadow-md`}>
                ...
                <div className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-800'}`}>Discount</div>
              </div>
              <div className={`p-4 rounded-lg ${isDarkMode ? 'bg-gray-700' : 'bg-white'} shadow-md`}>
                <div className="text-2xl font-bold text-green-600">$0</div>
                <div className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-800'}`}>Setup Fees</div>
              </div>
              <div className={`p-4 rounded-lg ${isDarkMode ? 'bg-gray-700' : 'bg-white'} shadow-md`}>
                <div className="text-2xl font-bold text-purple-600">100hrs</div>
                <div className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-800'}`}>Free Support</div>
              </div>
              <div className={`p-4 rounded-lg ${isDarkMode ? 'bg-gray-700' : 'bg-white'} shadow-md`}>
                <div className="text-2xl font-bold text-orange-600">Direct</div>
                <div className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-800'}`}>Founder Access</div>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <div className={`p-8 rounded-2xl shadow-xl transition-all duration-300 hover:scale-105 ${isDarkMode ? 'bg-gray-700 border border-gray-600' : 'bg-white border border-gray-200'}`}>
              ...
              <ul className={`space-y-3 ${isDarkMode ? 'text-gray-300' : 'text-gray-800'}`}>
                <li className="flex items-start">
...
<div className={`p-8 rounded-xl shadow-lg ${isDarkMode ? 'bg-gray-800' : 'bg-white'}`}>
  ...
  <form onSubmit={handlePilotSubmit} className="space-y-6">
    ...
    <div className="grid md:grid-cols-2 gap-4">
      <div>
        <label className={`block text-sm font-medium mb-2 ${isDarkMode ? 'text-gray-300' : 'text-gray-800'}`}>
          First Name *
        </label>
        <input
          type="text"
      ...
      <div>
        ...
        <div className="relative">
          ...
          <div className="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
            <svg className={`w-5 h-5 ${isDarkMode ? 'text-gray-400' : 'text-gray-700'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div className="flex justify-center pt-4">
      <button
        ...
        className={`group relative inline-flex items-center justify-center px-8 py-4 font-semibold text-white transition-all duration-200 rounded-xl transform ${
    ...
    {pilotSubmitStatus === "error" && (
      ...
      <section id="contact" className={`py-24 transition-colors duration-300 ${isDarkMode ? 'bg-gray-900' : 'bg-gray-50'}`}>
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className={`text-xl mb-12 ${isDarkMode ? 'text-gray-300' : 'text-gray-800'}`}>
          ...
          <div className={`${isDarkMode ? 'bg-gray-800' : 'bg-white'} p-8 rounded-2xl shadow-lg transition-colors duration-300`}>
            <h3 className={`text-2xl font-bold mb-6 ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>Get Started Today</h3>
            <p className={`text-lg mb-6 ${isDarkMode ? 'text-gray-300' : 'text-gray-800'}`}>
              Ready to transform your financial infrastructure? Sign up for free or contact our team to discuss your specific needs.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
              ...
              >
                ...
                <p className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-800'}`}>See the platform in action</p>
              </button>
              ...
              >
                ...
                <p className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-800'}`}>Discuss your specific needs</p>
              </button>
            </div>
          </div>
        </div>
            ...
            <form onSubmit={handleScheduleAppointment} className="p-6">
              ...
              <div className="flex gap-4">
                ...
                <button
                  type="button"
                  onClick={() => setShowScheduler(false)}
                  className={`group relative inline-flex items-center justify-center px-8 py-3.5 font-semibold rounded-xl transition-all duration-200 transform hover:-translate-y-0.5 hover:shadow-lg ${
                    isDarkMode 
                      ? 'bg-gray-800 text-gray-200 border-2 border-gray-700 hover:bg-gray-700 hover:border-gray-600' 
                      : 'bg-white text-gray-800 border-2 border-gray-300 hover:bg-gray-50 hover:border-gray-400'
                  }`}
