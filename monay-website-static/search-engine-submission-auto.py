#!/usr/bin/env python3
"""
Automated Search Engine Submission Script for Monay Website
...
class SearchEngineSubmitter:
    ...
    def submit_all(self):
        ...
        print("\n🚀 Starting Automated Search Engine Submission")
        print("="*60)
...
def create_indexnow_key():
    ...
    out_dir = "/Users/alisaberi/Downloads/monay/monay-website-static/out"
    os.makedirs(out_dir, exist_ok=True)
    
    key_file = f"{out_dir}/indexnow-{key}.txt"
...
if __name__ == "__main__":
    print("\n🔍 Monay Website Search Engine Submission Tool (Automated)")
    print("="*60)
    ...
    print(f"\nUsing website URL: {website_url}")
    
    # Create IndexNow key file
    print("\n📝 Creating IndexNow key file...")
    create_indexnow_key()
    
    # Automatically proceed with submission
    print("\n🔄 Proceeding with automatic submission...")
    ...
    print("\n⚠️  Note: The IndexNow key file needs to be uploaded to your website root")
    print("   for IndexNow submission to work properly.")