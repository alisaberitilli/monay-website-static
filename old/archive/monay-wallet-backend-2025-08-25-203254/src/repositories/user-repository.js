...
export default {
  ...
  */
  ...
  async createHashPassword(password) {
    try {
      // Temporary fallback for development - replace with proper bcrypt later
      if (!password) {
        throw new Error('Password is required');
      }
      
      console.log('Using fallback password hashing for development');
      return `dev_hash_${password}_${Date.now()}`;
      
      // TODO: Fix bcrypt compatibility issue and re-enable this:
      // const saltRounds = 10;
