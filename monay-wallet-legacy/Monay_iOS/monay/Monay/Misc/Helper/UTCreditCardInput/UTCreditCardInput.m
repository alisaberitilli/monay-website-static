...
//  Copyright © 2015 utkarsh. All rights reserved.
//
...
-(BOOL)textField:(UITextField *)textField shouldChangeCharactersInRange:(NSRange)range replacementString:(NSString *)string
{
    if ([textField isEqual:self.txfCreditCardNumber]) {
        ...
        if (!self.cardPatternInfo) {
            ...
            //            UIAlertController *alertController = [UIAlertController alertControllerWithTitle:@"" message:@"First enter your credit card number" preferredStyle:UIAlertControllerStyleAlert];
            //
        ...
        //            [Utility showAlert:@"First enter above info correctly" title:@""];
        //            return NO;
        //        }
...
//        return newLength <= validLength;
        ...
        if (!self.cardPatternInfo) {
            ...
            [self showAlert:@"Please first enter your valid card number"];
            return NO;
        }
...
- (NSString *)formattedStringFromRawString:(NSString *)rawString {
    ...
    if (patternInfo) {
      ...
      UTCardInfo *cardInfo = [[UTCardInfo alloc] init];
      return  [cardInfo groupedStringWithString:numberString groupSeparater:self.groupSeparater maskingCharacter:self.maskingCharacter maskingGroupIndexSet:self.maskingGroupIndexSet];
//        return numberString;
    }
