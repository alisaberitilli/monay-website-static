...
public extension Date {
    ...
    */
    ...
    /// Converts the date to another date based on a date format, optional timezone and optional locale.
    func toDate(format: DateFormatType, timeZone: TimeZoneType = .local, locale: Locale = Locale.current) -> Date {
        let formatter = Date.cachedFormatter(format.stringFormat, timeZone: timeZone.timeZone, locale: locale)
    ...
    // Different types of dateFormatter
    enum DateFormat {
        case fullDate, customFullDate, shortTime12, onlyDate, pickerDate, pickerSelectedDate, pickerTime, pickerSelectedTime, expireDate, custom(formatter: DateFormatter),monthYearFromatter, yyyyMMddHours24, hours24, hours12, customFullTimeFormatter
        ...
        var formatter: DateFormatter {
            ...
            case .pickerTime:
                return DateFormatter.dateFormatterPickerTime
            case .pickerSelectedTime:
                return DateFormatter.dateFormatterPickerSelectedTime
            case .pickerDate:
                return DateFormatter.dateFormatterPickerDate
            case .pickerSelectedDate:
                return DateFormatter.dateFormatterPickerSelectedDate
            case .expireDate:
                return DateFormatter.dateFormatterExpireDate
            case .monthYearFromatter:
                return DateFormatter.monthYearFromatter
            case .custom(let formatter):
                return formatter
            case .yyyyMMddHours24:
                return DateFormatter.yyyyMMddHours24
            case .hours24:
                return DateFormatter.hours24
            case .hours12:
                return DateFormatter.hours12
            case .customFullTimeFormatter:
                return DateFormatter.customFullTimeFormatter
            }
        }
    }
    
    // Converted Timezone and Date into String format
    ...
    // Converted String date and time for specific date format according to requirement
    func dateFromString(_ date: String, format: DateFormat , timeZone: TimeZone = .current) -> Date {
        ...
        //        return dateFormatter.date(from: date) ?? return
    }
...
public enum DateFormatType {
    ...
    /// A generic standard format for laravel date i.e. "MM/dd/yyyy"
    case laravel
    ...
    var stringFormat:String {
        ...
        case .laravel: return "MM/dd/yyyy"
...
extension DateFormatter {
    static let dateFormatterFullDate: DateFormatter = {
        let formatter = DateFormatter()
    ...
    ///MM/dd/yyyy
    static let dateFormatterOnlyDate: DateFormatter = {
        let formatter = DateFormatter()
    ...
    static let dateFormatterPickerDate: DateFormatter = {
        let formatter = DateFormatter()
        formatter.dateFormat = "dd MMM yyyy"
        return formatter
    }()
    
    static let dateFormatterPickerTime: DateFormatter = {
        let formatter = DateFormatter()
    ...
    static let dateFormatter24HrTime: DateFormatter = {
        let formatter = DateFormatter()
    ...
    static let dateFormatterPickerSelectedDate: DateFormatter = {
        let formatter = DateFormatter()
        formatter.dateFormat = "yyyy-MM-dd"
        return formatter
    }()
    
    static let dateFormatter_ddMMyyyy: DateFormatter = {
        let formatter = DateFormatter()
        formatter.dateFormat = "dd-MM-yyyy"
        return formatter
    }()
    
    static let dateFormatterPickerSelectedTime: DateFormatter = {
        let formatter = DateFormatter()
        formatter.dateFormat = "hh:mm:ss"
        return formatter
    }()
    
    static let customFullTimeFormatter: DateFormatter = {
        let formatter = DateFormatter()
        formatter.dateFormat = "HH:mm:ss"
        return formatter
    }()
    
    static let dateFormatterExpireDate: DateFormatter = {
        let formatter = DateFormatter()
        formatter.dateFormat = "dd MMM yyyy"
        return formatter
    }()
    
    // used in manage wallet cell
    ...
    // used in calenderpopupview
    static let monthToAlphabetsFormatter : DateFormatter = {
        let formatter = DateFormatter()
        formatter.dateFormat = "MMM"
        return formatter
    }()
    
    static let monthToDigitFormatter : DateFormatter = {
        let formatter = DateFormatter()
        formatter.dateFormat = "MM"
        return formatter
    }()
    
    static let monthToAlphabetsFullFormatter : DateFormatter = {
        let formatter = DateFormatter()
        formatter.dateFormat = "MMMM"
        return formatter
    }()
    
    static let monthYearFromatter : DateFormatter = {
        let formatter = DateFormatter()
        formatter.dateFormat = "MMM yyyy"
        return formatter
    }()
    
    static let yyyyMMddHours24: DateFormatter = {
        let formatter = DateFormatter()
