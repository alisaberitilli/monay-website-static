...
class CoreDataManager {
    ...
    private lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator = {
      ...
      var failureReason = LocalizedKey.messageErrorLoadingData.value
        do {
          ...
          dict[NSLocalizedDescriptionKey] = LocalizedKey.messageFailedInitData.value as AnyObject?
            dict[NSLocalizedFailureReasonErrorKey] = failureReason as AnyObject?
            
            dict[NSUnderlyingErrorKey] = error as NSError
          let wrappedError = NSError(domain: LocalizedKey.errorDomain.value, code: 9999, userInfo: dict)
...
//        }
      ...
      if self.bGManagedObjectContext.hasChanges{
         ...
         self.bGManagedObjectContext.performAndWait {
