...
class VerifyOtpOnlyResponse : BaseResponse<VerifyOtpOnlyResponse, String, Any>() {
    override fun doNetworkRequest(
        requestParam: HashMap<String, Any>,
        appPreference: AppPreference,
        networkResponseCallback: NetworkResponseCallback<VerifyOtpOnlyResponse>
    ): Disposable {
        val api = ApiFactory.clientWithHeader.create(ApiInterface::class.java)
        return api.verifyOtpOnlyApi(requestParam)
