...
//        parcel.readBoolean()
    ...
    companion object CREATOR : Parcelable.Creator<CardBean> {
        override fun createFromParcel(parcel: Parcel): CardBean {
            return CardBean(parcel)
        }

        override fun newArray(size: Int): Array<CardBean?> {
