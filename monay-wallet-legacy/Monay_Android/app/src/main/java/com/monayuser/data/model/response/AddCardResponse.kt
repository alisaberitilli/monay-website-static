...
class AddCardResponse : BaseResponse<AddCardResponse, String, Any>() {

    var data: CardBean? = null

    override fun doNetworkRequest(
        requestParam: HashMap<String, Any>,
        appPreference: AppPreference,
        networkResponseCallback: NetworkResponseCallback<AddCardResponse>
    ): Disposable {
        val api = ApiFactory.clientWithHeader.create(ApiInterface::class.java)
        return api.addCardAPI(
