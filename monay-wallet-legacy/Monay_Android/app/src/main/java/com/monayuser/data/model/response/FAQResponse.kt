...
import com.monayuser.data.model.bean.FAQBean
...
class FAQResponse : BaseResponse<FAQResponse, String, Any>() {

    var data: FAQBean? = null

    override fun doNetworkRequest(
        requestParam: HashMap<String, Any>,
        appPreference: AppPreference,
        networkResponseCallback: NetworkResponseCallback<FAQResponse>
    ): Disposable {
        val api = ApiFactory.clientWithHeader.create(ApiInterface::class.java)
        return api.getFAQData(
