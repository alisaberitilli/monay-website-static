...
import com.monayuser.data.model.bean.TermsBean
...
class TermsConditionsResponse : BaseResponse<TermsConditionsResponse, String, Any>() {

    var data: TermsBean? = null
    override fun doNetworkRequest(
        requestParam: HashMap<String, Any>,
        appPreference: AppPreference,
        networkResponseCallback: NetworkResponseCallback<TermsConditionsResponse>
    ): Disposable {
        val api = ApiFactory.clientWithHeader.create(ApiInterface::class.java)
        return api.getCMSData(
                requestParam
            )
