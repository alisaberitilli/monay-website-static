...
class DeclinedPaymentRequestResponse : BaseResponse<DeclinedPaymentRequestResponse, String, Any>() {

    override fun doNetworkRequest(
        requestParam: HashMap<String, Any>,
        appPreference: AppPreference,
        networkResponseCallback: NetworkResponseCallback<DeclinedPaymentRequestResponse>
    ): Disposable {
        val api = ApiFactory.clientWithHeader.create(ApiInterface::class.java)
        return api.declinedPaymentRequestApi(
