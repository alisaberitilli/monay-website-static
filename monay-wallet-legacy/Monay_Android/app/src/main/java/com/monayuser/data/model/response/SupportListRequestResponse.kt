...
import com.monayuser.data.model.bean.SupportRequestBean
...
class SupportListRequestResponse : BaseResponse<SupportListRequestResponse, String, Any>() {

    var data: SupportRequestBean? = null

    override fun doNetworkRequest(
        requestParam: HashMap<String, Any>,
        appPreference: AppPreference,
        networkResponseCallback: NetworkResponseCallback<SupportListRequestResponse>
    ): Disposable {
        val api = ApiFactory.clientWithHeader.create(ApiInterface::class.java)
        return api.supportListAPI(
