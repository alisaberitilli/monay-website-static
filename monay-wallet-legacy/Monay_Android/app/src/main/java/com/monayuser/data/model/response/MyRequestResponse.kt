...
class MyRequestResponse : BaseResponse<MyRequestResponse, String, Any>() {
    ...
    override fun doNetworkRequest(
        ...
        networkResponseCallback: NetworkResponseCallback<MyRequestResponse>
    ): Disposable {
        val api = ApiFactory.clientWithHeader.create(ApiInterface::class.java)
        return api.callMyRequestListAPI(
