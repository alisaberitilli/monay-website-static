...
class SecondaryUserActiveInactiveResponse : BaseResponse<SecondaryUserActiveInactiveResponse, String, Any>() {
    val data: SecondaryUserDetail? = null
    override fun doNetworkRequest(
        requestParam: HashMap<String, Any>,
        appPreference: AppPreference,
        networkResponseCallback: NetworkResponseCallback<SecondaryUserActiveInactiveResponse>
    ): Disposable {
        ...
        return api.secondaryUserActiveInactiveAPI(
            "${AppConstants.BEARER} ${
