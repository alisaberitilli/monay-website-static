...
import com.monayuser.data.model.bean.PrimaryUserBean
...
class PrimaryUserListResponse : BaseResponse<PrimaryUserListResponse, String, Any>() {

    var data: PrimaryUserBean? = null
    override fun doNetworkRequest(
        requestParam: HashMap<String, Any>,
        appPreference: AppPreference,
        networkResponseCallback: NetworkResponseCallback<PrimaryUserListResponse>
    ): Disposable {
        val api = ApiFactory.clientWithHeader.create(ApiInterface::class.java)
        return api.getPrimaryUserListAPI(
