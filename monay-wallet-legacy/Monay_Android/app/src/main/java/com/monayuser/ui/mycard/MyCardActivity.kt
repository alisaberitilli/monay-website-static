...
class MyCardActivity : BaseActivity<ActivityMyCardBinding, MyCardViewModel>(),
    ...
    override fun showAddNewCardDialog() {
        ...
        var cardText = CreditCardNumberFormattingTextWatcher(bottomSheet.etCardNumber)
        bottomSheet.etCardNumber.addTextChangedListener(cardText)
            ...
            val builder = MonthPickerDialog.Builder(
                ...
                MonthPickerDialog.OnDateSetListener { selectedMonth, selectedYear ->
                    ...
                    if ((year == selectedYear && selectedMonth >= month) || year < selectedYear) {
                        ...
                        yearMain = selectedYear.toString()
        ...
        bottomSheet.btnAddCard.setOnClickListener {
            ...
            cardName = bottomSheet.etCardHolderName.text.toString().trim()

            if (!bottomSheet.etCardNumber.text.toString().equals("")) {
                cardNumber =
                    bottomSheet.etCardNumber.text.toString()!!.replace("\\s".toRegex(), "").trim()
            } else {
                cardNumber = bottomSheet.etCardNumber.text.toString()!!
            }

            cvv = bottomSheet.etCvv.text.toString()
